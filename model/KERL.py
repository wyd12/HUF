...
class kerl(nn.Module):
    def __init__(self, num_users, num_items, model_args, device, HPGorKERL = 'HPG'):
    ...
    def RLtrain(self, batch_sequences, items_to_predict, pred_one_hot, train_len,tarlen):
        ...
        # generate 3 episode
        Reward = self.generateReward(sample1, self.args.T-1, 3, items_to_predict, pred_one_hot, h,tarlen)
